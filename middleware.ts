...
export const config = {
  matcher: [
     ...
     */
    '/((?!api|_next/static|_next/image|_vercel|\\.well-known|favicon\\.ico|robots\\.txt|sitemap\\.xml|llms\\.txt|google[a-z0-9]+\\.html|.*\\.(?:pdf|png|jpg|jpeg|webp|svg|ico|css|js|woff2?|map|json)).*)',
  ],
};
